...
export const  LoginMoadl = ({loginOpen, setLoginOpen}) => {
...
{loginOpen && (
    <div id="authentication-modal" tabIndex={-1}  className={`overflow-y-auto overflow-x-hidden fixed  pt-20  flex z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full   ${ismodalClosing ? 'animate-fadeOut'  :'animate-fadeDown'}`} >
            ...
            <div className="p-4 md:p-5">
                <form className="space-y-4" action="#">
                    ...
                    <div className="flex justify-between">
                        ...
                        <a href="#" className="text-sm  hover:underline text-[#fe8116]">Reset Password?</a>
                    </div>
                    <button type="submit" className="w-full text-gray-400 bg-[#615c61] font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Login to your account</button>
                    <div className="text-sm text-center font-medium text-[#615c61]">
                        Not registered? <a href="#" className="text-[#fe8116] hover:underline ">Create account</a>
                    </div>
                </form>
            </div>
        </div>
