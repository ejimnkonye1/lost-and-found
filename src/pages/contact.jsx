        ...
        <form className="w-full lg:w-[500px]">
           ...
           className= "rounded-full "
             ...
             InputProps={{
              ...
              multiline // Enable multiline for a larger text area
              rows={4} //number of visible rows 
             
            />
            </div>
            <div>
                <button type="submit" className="text-[#000] border border-[#000] bg-[#3F384A0D] w-full py-2 px-2 font-poppins rounded-full hover:text-[#FEA116] hover:border-[#FEA116] transition-colors duration-100 ease-linear
  ">
                    Send
                </button>
            </div>
